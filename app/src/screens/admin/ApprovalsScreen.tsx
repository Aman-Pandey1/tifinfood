...
export function ApprovalsScreen() {
  ...
  const approve = async (id: string) => { await api.post(`/admin/approve-seller/${id}`); refresh(); };
  const reject = async (id: string) => { await api.post(`/admin/reject-seller/${id}`); refresh(); };
